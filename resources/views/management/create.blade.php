    ...
    <div class="white_shd full margin_bottom_30">
        ...
        <div class="table_section padding_infor_info">
            <div class="table-responsive-sm">
                <form action="{{ route('addProfiles') }}" method="POST" class="p-2">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="col-md-12" style="margin-top:12px; margin-bottom:12px;">
                        ...
                        <span style="margin-right:20px;margin-bottom:20px;"> <input type="checkbox" id="checkbox" name="" value=""> Check All </span>
                    </div>
                    <div class="col-md-12" style="margin-top:12px; margin-bottom:12px;">
                        <h4> Managemanent Menu </h4>
                        <span style="margin-right:20px;margin-bottom:20px;"> <input type="checkbox" name="access[]" value="management"> Management Menu
                        </span>
                ...
                <script>
                    document.querySelector('#checkbox').addEventListener('change', (e) => {
                        const checkboxes = document.getElementsByName('access[]');
